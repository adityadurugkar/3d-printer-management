...
export default function PrinterChart({ data = [] }) {
  return (
    <div className="bg-card border rounded-xl p-6">
      <h3 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-1">Analytics</h3>
      <h2 className="text-lg font-bold mb-4">Printers by Brand</h2>
      {data.length === 0 ? (
