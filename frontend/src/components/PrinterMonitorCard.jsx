      ...
      <div className="relative p-4 pb-3">
        <div className="flex items-start justify-between mb-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-sm text-white group-hover:text-primary transition-colors">{printer.name}</h3>
              <p className="text-xs text-white/40 font-mono">#{printer.serialNumber || 'N/A'}</p>
            </div>
          </div>
